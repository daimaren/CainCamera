...
import com.cgfay.media.editor.VideoEditor;
 ...
 * 视频编辑页面，按照时间线添加特效
 */
public class VideoEditorFragment extends Fragment implements View.OnClickListener {
    ...
    public static VideoEditorFragment newInstance() {
        ...
        public void onStopTrackingTouch(SeekBar seekBar) {
            if (seekBar.getId() == R.id.sb_volume_background) {
                ...
                if (mVideoEditor != null) {
                    ...
                    mVideoEditor.setVolume(mSourceVolumePercent, mSourceVolumePercent);
                }
            }
        }
    };
    ...
    private VideoEffectAdapter.OnEffectChangeListener mEffectChangeListener = new VideoEffectAdapter.OnEffectChangeListener() {
        ...
        public void onEffectChanged(EffectType effectType) {
            if (mVideoEditor != null) {
                mVideoEditor.changeEffect(effectType.getName());
            }
        }
        ...
        public void beginEffect(EffectType effectType) {
            if (mVideoEditor != null) {
                mVideoEditor.beginEffect(effectType.getName());
            }
        }
        ...
        public void endEffect(EffectType effectType) {
            if (mVideoEditor != null) {
                mVideoEditor.endEffect(effectType.getName());
            }
        }
