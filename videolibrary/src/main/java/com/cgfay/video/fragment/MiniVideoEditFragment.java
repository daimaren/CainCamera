...
import com.cgfay.media.MiniMediaPlayer;
 ...
 * 特效编辑页面
 */
public class MiniVideoEditFragment extends Fragment implements View.OnClickListener {
    ...
    public static MiniVideoEditFragment newInstance() {
        return new MiniVideoEditFragment();
    }
    ...
    public void onStart() {
        ...
        if (mMediaPlayer == null) {
            mMediaPlayer = new MiniMediaPlayer();
        }
    }
    ...
    private void openMediaPlayer() {
        ...
        mMediaPlayer.setOnCurrentPositionListener(new MiniMediaPlayer.OnCurrentPositionListener() {
            @Override
    ...
    private VideoEffectAdapter.OnEffectChangeListener mEffectChangeListener = new VideoEffectAdapter.OnEffectChangeListener() {
        ...
        public void onEffectChanged(EffectType effectType) {
            if (mMediaPlayer != null) {
                mMediaPlayer.changeEffect(effectType.getName());
            }
        }
        ...
        @Override
        public void endEffect(EffectType effectType) {
            if (mMediaPlayer != null) {
                mMediaPlayer.endEffect(effectType.getName());
            }
        }

        @Override
        public void deleteLastEffect(EffectType effectType) {

        }

        @Override
        public void deleteAllEffects(EffectType effectType) {
