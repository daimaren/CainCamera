...
import com.cgfay.video.fragment.VideoEditorFragment;

public class VideoEditorActivity extends AppCompatActivity implements VideoEditorFragment.OnSelectMusicListener,
        MusicSelectFragment.OnMusicSelectedListener, VideoEditorFragment.OnEditPreviewListener {

    public static final String VIDEO_PATH = "videoPath";

    private static final String FRAGMENT_VIDEO_EDIT = "fragment_video_editor";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (null == savedInstanceState) {
            ...
            VideoEditorFragment fragment = VideoEditorFragment.newInstance();
    ...
    public void onBackPressed() {
        ...
        if (backStackEntryCount == 1) {
            VideoEditorFragment fragment = (VideoEditorFragment) getSupportFragmentManager()
