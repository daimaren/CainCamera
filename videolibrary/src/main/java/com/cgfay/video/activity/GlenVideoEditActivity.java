...
import com.cgfay.video.fragment.GlenVideoEditFragment;
import com.cgfay.video.fragment.VideoEditFragment;

public class GlenVideoEditActivity extends AppCompatActivity implements GlenVideoEditFragment.OnSelectMusicListener,
        MusicSelectFragment.OnMusicSelectedListener, GlenVideoEditFragment.OnEditPreviewListener {
...
//        hideNavigationBar();
        ...
        if (null == savedInstanceState) {
            ...
            GlenVideoEditFragment fragment = GlenVideoEditFragment.newInstance();
    ...
    public void onBackPressed() {
        ...
        if (backStackEntryCount == 1) {
            GlenVideoEditFragment fragment = (GlenVideoEditFragment) getSupportFragmentManager()
