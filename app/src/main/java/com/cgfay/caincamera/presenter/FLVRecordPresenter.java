...
import com.cgfay.media.recorder.FLVRecorder;
...
public class FLVRecordPresenter implements Camera.PreviewCallback, AudioRecorder.OnRecordCallback,
    ...
    private FLVRecordFragment mFragment;
    ...
    private FLVRecorder mMediaRecorder;
    private boolean mIsRecording;
    private Handler mHandler;

    private final List<VideoInfo> mVideoList;

    public FLVRecordPresenter(Activity activity, FLVRecordFragment fragment) {
        mActivity = activity;
        mFragment = fragment;
        mIsRecording = false;
        mPreviewRotate = 0;
