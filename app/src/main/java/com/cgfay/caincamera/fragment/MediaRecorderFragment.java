...
import com.cgfay.caincamera.presenter.MediaRecordPresenter;
import com.cgfay.caincamera.renderer.FFRecordRenderer;
import com.cgfay.caincamera.renderer.MediaRecordRenderer;
 ...
 * 利用FFmpeg录制视频
 */
public class MediaRecorderFragment extends Fragment implements View.OnClickListener {

    private static final String TAG = "MediaRecorderFragment";
    ...
    private MediaRecordRenderer mRenderer;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mPresenter = new MediaRecordPresenter(mActivity, this);
        mPresenter.setRecordSeconds(15);
        mRenderer = new MediaRecordRenderer(mPresenter);
