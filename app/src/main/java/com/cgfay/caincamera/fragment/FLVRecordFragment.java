...
import com.cgfay.caincamera.presenter.FLVRecordPresenter;
import com.cgfay.caincamera.renderer.FFRecordRenderer;
import com.cgfay.caincamera.renderer.FLVRecordRenderer;
 ...
 * 录制FLV视频
 */
public class FLVRecordFragment extends Fragment implements View.OnClickListener {

    private static final String TAG = "FLVRecordFragment";
    ...
    private FLVRecordPresenter mPresenter;
    private FLVRecordRenderer mRenderer;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mPresenter = new FLVRecordPresenter(mActivity, this);
        mPresenter.setRecordSeconds(15);
        mRenderer = new FLVRecordRenderer(mPresenter);
