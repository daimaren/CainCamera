 ...
 * FFmpeg录制渲染器
 */
public class FLVRecordRenderer implements GLSurfaceView.Renderer {
    ...
    private final WeakReference<FLVRecordPresenter> mWeakPresenter;

    public FLVRecordRenderer(FLVRecordPresenter presenter) {
