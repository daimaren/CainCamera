 ...
 * FFmpeg录制渲染器
 */
public class MediaRecordRenderer implements GLSurfaceView.Renderer {

    private static final String TAG = "MediaRecordRenderer";
    ...
    private final WeakReference<MediaRecordPresenter> mWeakPresenter;

    public MediaRecordRenderer(MediaRecordPresenter presenter) {
