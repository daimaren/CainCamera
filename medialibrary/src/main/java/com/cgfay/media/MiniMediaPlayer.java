 ...
 */
public class MiniMediaPlayer implements IMediaPlayer {
    ...
    static {
        ...
        System.loadLibrary("minivideoeditor");
        native_init();
    }

    private static final String TAG = "MiniMediaPlayer";
    ...
    public MiniMediaPlayer() {
         ...
         */
        native_setup(new WeakReference<MiniMediaPlayer>(this));
    }
     ...
     */
    public static MiniMediaPlayer create(Context context, Uri uri) {
     ...
     * @return a MediaPlayer object, or null if creation failed
     */
    public static MiniMediaPlayer create(Context context, Uri uri, SurfaceHolder holder) {

        try {
            MiniMediaPlayer mp = new MiniMediaPlayer();
     ...
     * @return a MediaPlayer object, or null if creation failed
     */
    public static MiniMediaPlayer create(Context context, int resid) {
        try {
    ...
    public void setWakeMode(Context context, int mode) {
        ...
        mWakeLock = pm.newWakeLock(mode| PowerManager.ON_AFTER_RELEASE, MiniMediaPlayer.class.getName());
    ...
    private class EventHandler extends Handler {
        ...
        private MiniMediaPlayer mMediaPlayer;

        public EventHandler(MiniMediaPlayer mp, Looper looper) {
            super(looper);
            mMediaPlayer = mp;
        }
    ...
    private static void postEventFromNative(Object mediaplayer_ref,
        ...
        final MiniMediaPlayer mp = (MiniMediaPlayer)((WeakReference) mediaplayer_ref).get();
        if (mp == null) {
            return;
        }
