 ...
 */
public class GlenMediaPlayer implements IMediaPlayer {
    ...
    private static final String TAG = "GlenMediaPlayer";
    ...
    public GlenMediaPlayer() {
         ...
         */
        native_setup(new WeakReference<GlenMediaPlayer>(this));
    }
     ...
     */
    public static GlenMediaPlayer create(Context context, Uri uri) {
     ...
     * @return a MediaPlayer object, or null if creation failed
     */
    public static GlenMediaPlayer create(Context context, Uri uri, SurfaceHolder holder) {

        try {
            GlenMediaPlayer mp = new GlenMediaPlayer();
     ...
     * @return a MediaPlayer object, or null if creation failed
     */
    public static GlenMediaPlayer create(Context context, int resid) {
        try {
    ...
    public void setWakeMode(Context context, int mode) {
        ...
        mWakeLock = pm.newWakeLock(mode| PowerManager.ON_AFTER_RELEASE, GlenMediaPlayer.class.getName());
    ...
    private class EventHandler extends Handler {
        ...
        public EventHandler(GlenMediaPlayer mp, Looper looper) {
            super(looper);
            mMediaPlayer = mp;
        }
    ...
    private static void postEventFromNative(Object mediaplayer_ref,
        ...
        final GlenMediaPlayer mp = (GlenMediaPlayer)((WeakReference) mediaplayer_ref).get();
        if (mp == null) {
            return;
        }
