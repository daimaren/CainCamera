...
void MiniRecorder::destroyEGLContext() {
    ...
    delete mHandler;
    mHandler = NULL;
    LOGI("MiniRecorder thread stopped");
}
...
void MiniRecorder::initFlvWriter() {
 ...
 * Save Flv AudioTag
 */
void MiniRecorder::saveFlvAudioTag(aw_flv_audio_tag *audio_tag) {
    if(!audio_tag){
 ...
 * Save Flv VideoTag
 */
void MiniRecorder::saveFlvVideoTag(aw_flv_video_tag *video_tag) {
 ...
 */
void MiniRecorder::saveSpsPpsAndAudioSpecificConfigTag() {
...
void MiniRecorder::save_audio_data(aw_flv_audio_tag *audio_tag){
    save_flv_tag_to_file(&audio_tag->common_tag);
}

void MiniRecorder::save_video_data(aw_flv_video_tag *video_tag) {
    save_flv_tag_to_file(&video_tag->common_tag);
}

void MiniRecorder::save_script_data(aw_flv_script_tag *script_tag) {
    save_flv_tag_to_file(&script_tag->common_tag);
}

void MiniRecorder::save_flv_tag_to_file(aw_flv_common_tag *commonTag) {
    if (commonTag) {
