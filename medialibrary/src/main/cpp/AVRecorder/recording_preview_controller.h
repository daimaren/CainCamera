#ifndef RECORDING_PREVIEW_CONTROLLER_H
#define RECORDING_PREVIEW_CONTROLLER_H
...
public:
    MVRecordingPreviewHandler(RecordingPreviewController *previewController, MessageQueue *queue)
            :
            Handler(queue) {
...
#endif // RECORDING_PREVIEW_CONTROLLER_H
